...
<body>
	<!--表单弹出层-->
	<div id="win" class="easyui-window" title="单车"
		...
		<div align="center" style="padding-top: 20px">
			<form id="editForm" method="post" enctype="multipart/form-data">
				<table>
					...
					<tr class="mTr">
						<td>图片</td>
						<td><input class="easyui-filebox" name="bikeIcon"
					...
					<tr class="mTr">
						...
						<td><input
							...
							class="easyui-validatebox" type="text" name="bName" /></td>
					</tr>
					<tr class="mTr">
						<td>类别：</td>
						<td><input id="bCid" class="easyui-combobox" name="bCid"
							data-options="valueField:'cid',textField:'cName',url:'bike/loadCategory',required:true,editable:false" />
						</td>
					</tr>
					<tr>
						<td>数量：</td>
						<td><input type="text" id="bCount" class="easyui-numberbox"
							name="bCount"
							data-options="min:1,max:1000,precision:0,required:true" /></td>
					</tr>
					<tr class="mTr">
						<td>目前状态：</td>
						<td><select id="bState" class="easyui-combobox"
							data-options="required:true,editable:false " name="bState"
							style="width: 220px;">
					...
					<tr height="50px">
						...
						<td>购入时间：</td>
						<td><input data-options="editable:false" name="bInTime"
							id="bInTime" type="text" class="easyui-datebox"
							required="required" /></td>
					</tr>
					<tr class="mTr">
						<td>备注：</td>
						<td><textarea name="bComment"
								style="width: 220px; height: 100px"></textarea></td>
					</tr>
					<tr class="mTr">
						<td><a id="submitBtn" href="javascript:void(0);"
							class="easyui-linkbutton"
							data-options="text:'保存',iconCls:'icon-save',plain:true"> <a
								id="resetBtn" href="javascript:void(0);"
								class="easyui-linkbutton"
								data-options="text:'重置',iconCls:'icon-save',plain:true"></td>
					</tr>
				</table>
			</form>
		</div>
	...
	<div id="toolbar">
		<a id="addBtn" href="javascript:void(0);" class="easyui-linkbutton"
			data-options="text:'添加',iconCls:'icon-add',plain:true"> </a> <a
			id="updateBtn" href="javascript:void(0);" class="easyui-linkbutton"
			data-options="text:'修改单车',iconCls:'icon-edit',plain:true"> </a> <a
			id="removeBtn" href="javascript:void(0);" class="easyui-linkbutton"
			data-options="text:'移除单车',iconCls:'icon-remove',plain:true"> </a>
	</div>
	<!--单车表格-->
	<table id="dg"></table>
</body>
    ...
    $(function () {
        ...
        $('#dg').datagrid({
            ...
            columns:[[
                ...
                {field:'bCid',title:'单车类别号',width:50,align:'center'},

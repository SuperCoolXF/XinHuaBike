...
<body>
	<!--表单弹出层-->
	<div id="win" class="easyui-window" title="订单"
				...
				<table>
					...
					<tr class="mTr">
						...
						<td><input id="oSno"
							...
							class="easyui-validatebox" type="text" name="oSno" /></td>
					</tr>
					<tr class="mTr">
						<td>单车号：</td>
						<td><input id="oBid"
							data-options="required:true,validType:'length[0,30]'"
							class="easyui-validatebox" type="text" name="oBid" /></td>
					</tr>
					<tr class="mTr">
						<td>目前状态：</td>
						<td><select id="oState" class="easyui-combobox"
							data-options="editable:false,required:true" name="oState"
							style="width: 220px;">
	...
	<div id="toolbar">
		<a id="addBtn" href="javascript:void(0);" class="easyui-linkbutton"
			data-options="text:'添加订单',iconCls:'icon-add',plain:true"> </a> <a
			id="updateBtn" href="javascript:void(0);" class="easyui-linkbutton"
			data-options="text:'归还单车',iconCls:'icon-edit',plain:true"> </a> <a
			id="removeBtn" href="javascript:void(0);" class="easyui-linkbutton"
			data-options="text:'移除订单',iconCls:'icon-remove',plain:true"> </a>
	</div>
	<!--订单表格-->
	<table id="dg"></table>
</body>

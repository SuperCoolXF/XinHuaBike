		...
		<form id="editForm" method="post" style="margin: 50px 0 0 100px">
			<table class="table table-bordered" style="width: 350px">
				...
				<tr style="height: 30px;">
					<td>原来密码： <%--<input  data-options="required:true," class="easyui-validatebox" type ="password" name ="name" />--%>
				...
				<tr style="height: 30px">
					<td>新的密码： <input id="newPassword" type="password"
						name="newPassword" class="easyui-textbox"
						data-options="iconCls:'icon-lock',required:true">
					</td>
				</tr>
				<tr style="height: 30px">
					<td>确认密码： <input id="newPassword2" type="password"
						name="newPassword2" class="easyui-textbox"
						data-options="iconCls:'icon-lock',required:true">
					</td>
				</tr>
				<tr>
					<td><a style="margin: 15px 20px 15px 65px" id="submitBtn"
						href="javascript:void(0);" class="easyui-linkbutton"
						data-options="text:'保存',iconCls:'icon-save'" /> <a
						style="margin: 15px auto 15px 65px" id="resetBtn"
						href="javascript:void(0);" class="easyui-linkbutton"
						data-options="text:'重置',iconCls:'icon-save'" /></td>
				</tr>
			</table>
		</form>
	</div>

...
<title>xinhua校园共享单车管理系统首页</title>
<style type="text/css">
ui {
	line-height: 30px;
}
...
<body class="easyui-layout">
	...
	<div data-options="region:'north',split:true" style="height: 95px;">
		...
		<div style="position: absolute; left: 35%; top: 10px">
			<p style="font-family: MyNewFont">
				<font color="#4ac9ff" size="7px">XinHua</font><font size="7px"
					color="#ff508b">bike</font><font color="#" size="4px">&nbsp;共享单车管理系统</font>
			</p>
		</div>
		<div style="position: absolute; right: 30px; top: 25px">
			<font color="red">[${sessionScope.admin.aRealName}]&nbsp;</font>${sessionScope.admin.aRole}&nbsp;你好!&nbsp;你上次登陆的时间是:<mark>
				<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
					value="${sessionScope.admin.aLoginTime}" />
			</mark>
	...
	<!--foot-->
	<div data-options="region:'south',title:'版权所属',split:true"
		style="height: 80px;">
		<div id="copyrightDiv" style="text-align: center">
			copyright@XinHuaUniversity <br>
		</div>
	</div>
	<!--左边菜单-->
	<div data-options="region:'west',title:'系统菜单',split:true"
		...
		<div id="aa" class="easyui-accordion" style="width: 193px"
			data-options="multiple:true,border:0">

			<c:if test="${sessionScope.admin.aRole eq '超级管理员' }">
				<div title="系统用户管理" data-options="iconCls:'icon-man',selected:true "
			...
			<div title="单车信息管理" data-options="iconCls:'icon-search'"
				style="overflow: auto; padding: 10px;">
				<ui>
				<li><a href="javascript:void(0);" pageUrl="bike/bikeManage">单车管理</a></li>
				<li><a href="javascript:void(0);"
					pageUrl="category/categoryManage">分类管理</a></li>
				</ui>
			</div>

			<div title="学生信息管理" data-options="iconCls:'icon-reload'"
				style="padding: 10px;">
				<ui>
				<li><a href="javascript:void(0);"
					pageUrl="student/studentManage">管理录入的学生</a></li>
				</ui>
			</div>

			<div title="租赁信息管理" data-options="iconCls:'icon-ok',selected:true"
				style="padding: 10px;">
				<ui>
				<li><a href="javascript:void(0);" pageUrl="orders/ordersManage">单车租赁</a></li>
				</ui>
			</div>
			<div title="信息统计管理" data-options="iconCls:'icon-sum'"
				style="padding: 10px;">
				<ui>
				<li><a href="javascript:void(0);" pageUrl="total/totalManage">信息统计汇总</a></li>
				</ui>
			</div>
			<div title="个人信息管理" data-options="iconCls:'icon-edit' "
				style="padding: 10px;">
				<ui>
				<li><a href="javascript:void(0);" pageUrl="admin/rePassword"
					id="rePassword">更改密码</a></li>
				</ui>
			</div>
		</div>
	</div>
	...
	<div data-options="region:'center',title:'内容显示'"
		...
		<div id="tt" class="easyui-tabs" data-options="fit:true">
			<div title="欢迎页" style="padding: 20px; display: none;">
				欢迎登陆xinhua校园共享单车管理系统！你管理的服务点是${sessionScope.admin.place.pName},位于${sessionScope.admin.place.pAddress}。:-)
			</div>
		</div>
	</div>
</body>
